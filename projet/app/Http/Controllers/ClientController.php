...
class ClientController extends Controller
{
    ...
    public function recherche(int $id){
     ...
     public function pdf(Request $request){
        ...
        $prix_unit = (int)$request->ptotal / (int)$request->dure;
     ...
     public function upload(Request $request){
        ...
        if($request->hasfile('image'))
        {
            ...
            $file->move('uploads/materiel/', $filename);
            $materiel->image = $filename;
        }

        $materiel->save();
        if($materiel){
            return back()->with('ajout','Materiel ajouté avec success');
        }else{
            return back()->with('pas','erreur');
